...
**Base URL:** `https://your-domain.com/api/admin/settings`
...
```javascript
const response = await fetch('https://your-domain.com/api/admin/settings', {
  method: 'GET',
...
**GET Request:**
```
GET https://your-domain.com/api/admin/settings
```

**PATCH Request:**
```
PATCH https://your-domain.com/api/admin/settings
