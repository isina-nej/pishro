  ...
  return (
    <div ref={ref} className="container mx-auto px-4 py-20">
      <motion.div
        ...
        className="relative bg-gradient-to-br from-[var(--btn-primary-bg)] via-[var(--btn-primary-hover)] to-[var(--btn-primary-bg)] rounded-3xl overflow-hidden shadow-2xl"
      >
        {/* Animated Background */}
        ...
        <div className="relative z-10 p-12 md:p-16">
          {/* ponytail: on-gradient white ink; add --home-on-dark var when gradient theming changes */}
