    ...
    <div ref={ref} className="container mx-auto px-4 py-20">
      ...
      >
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 right-10 w-64 h-64 bg-card dark:bg-cardBg rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-10 left-10 w-80 h-80 bg-card dark:bg-cardBg rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>
        ...
        <div className="relative z-10 p-12 md:p-16">
          <div className="max-w-4xl mx-auto text-center text-foreground">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-card dark:bg-cardBg backdrop-blur-sm rounded-full px-6 py-2 mb-6"
            >
            ...
            >
              <Link
                href={ctaButtonLink}
                className="group bg-card dark:bg-cardBg text-myPrimary px-8 py-4 rounded-xl font-bold text-lg hover:shadow-2xl transition-all duration-300 flex items-center justify-center gap-2"
              >
