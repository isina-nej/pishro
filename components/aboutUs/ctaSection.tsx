  ...
  return (
    <div ref={ref} className="container-md py-20">
      <motion.div
        ...
        className="relative overflow-hidden rounded-[2.5rem] border border-border/15 bg-gradient-to-br from-[#102d42] via-[#16384e] to-[#0a2233] shadow-2xl"
      >
        {/* Animated Background */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 right-10 w-64 h-64 bg-card rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-10 left-10 w-80 h-80 bg-card rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>
        ...
        <div className="relative z-10 p-12 md:p-16">
          <div className="max-w-4xl mx-auto text-center text-foreground">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 rounded-full border border-border/25 bg-card/10 px-6 py-2 mb-6 text-primary-foreground backdrop-blur-sm"
            >
            ...
            >
              <Link
                href={ctaButtonLink}
                className="group bg-card text-myPrimary px-8 py-4 rounded-xl font-bold text-lg hover:shadow-2xl transition-all duration-300 flex items-center justify-center gap-2"
              >
