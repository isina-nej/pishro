  ...
  return (
    <div className="relative w-full h-full">
      {!error ? (
        ...
        <div className="w-full h-full flex flex-col items-center justify-center bg-muted dark:bg-darkBgHidden text-muted-foreground dark:text-textSecondary rounded-3xl shadow-inner text-xs">
