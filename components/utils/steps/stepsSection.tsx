...
const StepItem = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-6 right-8 bg-muted dark:bg-darkBgHidden rounded-full size-16 flex justify-center items-center">
        <div
          className={clsx(
            "size-8 rounded-full transition",
            isActive ? "bg-premium" : "bg-accent dark:bg-darkBgHidden"
          )}
        />

        {isActive && (
          <motion.div
            className="absolute size-8 rounded-full bg-premium"
      ...
      >
        <h3 className="text-[22px] font-bold text-foreground dark:text-textPrimary mb-2 mt-1">
          {step.title}
        </h3>
        <p className="text-muted-foreground dark:text-textSecondary mb-4 leading-7 max-w-[240px]">
          {step.description}
        </p>
        ...
        >
          <p className="text-[160px] font-black text-muted-foreground">{step.id}</p>
        </div>
      </motion.div>
    </motion.div>
  );
        ...
        <div className="sticky top-0 h-screen container-xl">
          ...
          <div className="relative flex w-[80%] [aspect-ratio:1071/449]">
            ...
            <div className="absolute flex flex-col justify-start py-6 px-4 w-[65%] right-0 -top-16 z-10">
              ...
              <h2 className="text-5xl leading-tight font-extrabold text-foreground dark:text-textPrimary max-w-[700px]">
                {sectionTitle}
              </h2>
              <p className="mt-4 max-w-[620px] text-muted-foreground dark:text-textSecondary leading-7">
                {sectionSubtitle}
              </p>
              <button className="rounded-full hover:text-[#344052] text-primary-foreground bg-[#344052] hover:bg-card dark:bg-cardBg transition-all duration-300 font-bold px-4 py-2.5 border-2 border-[#344052] flex items-center justify-center w-fit mt-8">
                {sectionCta}
              </button>
            </div>
