        ...
        <div className="relative flex items-center justify-end gap-3 mt-2 w-[260px]">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-1 bg-card border border-border px-3 py-1.5 rounded-lg shadow-sm hover:shadow-md transition text-sm font-bold">
                <ChevronDown size={16} />
            ...
            >
              {levelOptions.map((level) => (
                <DropdownMenuItem
                  ...
                  className={`cursor-pointer rtl text-right text-sm px-4 py-2 hover:bg-muted ${
