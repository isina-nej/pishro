      ...
      <div className="container-xl text-center px-4 sm:px-6 md:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 place-items-center max-w-7xl mx-auto">
          {levels.map((levelItem, i) => (
            ...
            >
              <div className="bg-card size-20 sm:size-[88px] md:size-24 flex items-center justify-center rounded-full shadow-md">
              ...
              <button
                ...
                className="mt-4 sm:mt-5 md:mt-6 px-8 sm:px-10 md:px-12 py-3 sm:py-3.5 md:py-4 bg-card text-mySecondary text-sm sm:text-base md:text-lg font-semibold rounded-full hover:scale-105 transition-all w-full sm:w-auto"
