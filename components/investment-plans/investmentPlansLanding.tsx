...
const InvestmentPlansLanding = ({
  ...
  return (
    <div className="relative w-full h-screen lg:h-screen overflow-hidden isolate flex items-center justify-start text-center px-4 mb-32">
      ...
      <div className="relative z-20 max-w-2xl text-primary-foreground flex flex-col items-center rtl gap-y-8 px-8">
        <h1 className="text-4xl lg:text-5xl font-bold leading-tight">
          {investmentPlansData.title}
        </h1>
        <p className="text-lg lg:text-xl text-primary-foreground/90 lg:leading-8">
