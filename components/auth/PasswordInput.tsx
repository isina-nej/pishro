    ...
    <div className="mt-5">
      ...
      <div className="relative">
        <Input
          ...
          className={cn(
            "mt-1 pr-10 pl-8 block w-full rounded-none border-0 border-b border-input bg-transparent focus:border-primary focus-visible:ring-0 focus-visible:bg-muted",
