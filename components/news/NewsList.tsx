...
const NewsList = () => {
    ...
    return (
      <div className="mt-8 flex justify-center items-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="mt-4 text-muted-foreground dark:text-textSecondary">در حال بارگذاری اخبار...</p>
        </div>
      </div>
    );
  }
  ...
  if (!data?.items || data.items.length === 0) {
    return (
      <div className="mt-8 flex justify-center items-center min-h-[400px]">
        <p className="text-muted-foreground dark:text-textSecondary">هیچ خبری یافت نشد</p>
      </div>
    );
  }
