  ...
  return (
    <div className="container-md flex justify-between gap-20 my-20">
      ...
      >
        ...
        <p className="text-xl leading-9 text-muted-foreground text-center">
        ...
        <Link href="/business-consulting" className="mt-8">
          <motion.button
            ...
            className="text-primary-foreground text-xl px-12 py-4 rounded-full bg-primary font-bold overflow-hidden shadow-lg hover:shadow-xl"
          >
            شروع کنیم
          </motion.button>
        </Link>
