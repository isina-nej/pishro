    ...
    <div className="z-10 py-20 container-md flex items-center justify-between gap-8 relative">
      ...
      <div className="flex-1 overflow-hidden">
        <div className="relative w-full h-[620px] mr-10 rounded-[2rem] overflow-hidden shadow-2xl">
          ...
          <Link
            href="/about-us"
            className="absolute left-6 bottom-6 inline-flex items-center justify-center rounded-full bg-primary px-8 py-4 text-lg font-medium text-primary-foreground shadow-2xl shadow-primary/25 transition-transform duration-300 hover:-translate-y-1 hover:scale-105"
          >
            بیشتر
          </Link>
        </div>
