...
/** Fallback FAQ copy for legacy/unused components. Live FAQ page reads from DB via /api/faqs. */
export const faqData = [
  {
    question: "میتوانم سفارشم را به‌صورت اقساطی (اعتباری) پرداخت کنم؟",
    answer:
      "بله. برای بخشی از دوره‌ها امکان پرداخت اقساطی از طریق درگاه‌های اعتباری فعال است. جزئیات هر دوره در صفحه همان دوره اعلام می‌شود.",
  },
  {
    question: "چگونه به محتوای دوره بعد از خرید دسترسی پیدا کنم؟",
    answer:
      "پس از تکمیل پرداخت، دوره در بخش «دوره‌های من» پروفایل شما فعال می‌شود و می‌توانید بلافاصله تماشا کنید.",
  },
  {
    question: "آیا گواهی پایان دوره صادر می‌شود؟",
    answer:
      "برای دوره‌هایی که گواهی دارند، پس از گذراندن آزمون یا تکمیل سرفصل‌ها گواهی دیجیتال صادر می‌شود.",
  },
  {
    question: "در صورت مشکل فنی با پشتیبانی چگونه تماس بگیرم؟",
    answer:
      "از طریق تیکت پشتیبانی در پروفایل یا راه‌های ارتباطی درج‌شده در صفحه تماس با ما می‌توانید درخواست خود را ثبت کنید.",
  },
];
