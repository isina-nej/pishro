    ...
    sections: [
      {
        ...
        fields: [
          ...
          iconField("hero.ctaIcon", "دکمه تماس — آیکن", "PhoneCall"),
          ...
          iconField("hero.phoneCtaIcon", "دکمه پشتیبانی — آیکن", "PhoneCall"),
          field("hero.calculatorCta", "متن دکمه محاسبه سود", "محاسبه سود"),
          iconField("hero.calculatorCtaIcon", "دکمه محاسبه — آیکن", "Calculator"),
      ...
      },
      {
        ...
        fields: [
          ...
          iconField("phone.confirmIcon", "دکمه تأیید — آیکن", "CheckCircle2"),
        ],
      },
      {
        id: "trust",
      ...
      },
      {
        ...
        fields: [
          ...
          iconField("split.ctaIcon", "دکمه تماس — آیکن", "ArrowLeft"),
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          iconField("calculator.investIcon", "دکمه سرمایه‌گذاری — آیکن", "Wallet"),
          field("calculator.reserve", "متن دکمه رزرو", "رزرو مشاوره حضوری"),
          iconField("calculator.reserveIcon", "دکمه رزرو — آیکن", "PhoneCall"),
          ...
          iconField("calculator.callIcon", "دکمه تماس — آیکن", "PhoneCall"),
      ...
      },
      {
        ...
        fields: [
          ...
          iconField("club.submitIcon", "دکمه — آیکن", "Send"),
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          iconField("cta.buttonIcon", "دکمه — آیکن", "ArrowLeft"),
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          iconField("summary.continueIcon", "دکمه ادامه — آیکن", "ArrowLeft"),
          field("summary.connecting", "اتصال به درگاه", "در حال اتصال به درگاه..."),
          field("summary.securePay", "پرداخت امن", "پرداخت امن"),
          iconField("summary.securePayIcon", "دکمه پرداخت — آیکن", "Wallet"),
      ...
      },
      {
        ...
        fields: [
          ...
          iconField("empty.coursesIcon", "دکمه دوره‌ها — آیکن", "ArrowRight"),
          field("empty.home", "بازگشت خانه", "بازگشت به صفحه اصلی"),
          iconField("empty.homeIcon", "دکمه خانه — آیکن", "Home"),
    ...
    sections: [
      {
        ...
        fields: [
          ...
          iconField("hero.ctaIcon", "دکمه — آیکن", "ArrowLeft"),
    ...
    sections: [
      {
        ...
        fields: [
          ...
          iconField("inPerson.buttonIcon", "دکمه حضوری — آیکن", "PhoneCall"),
          ...
          iconField("online.buttonIcon", "دکمه آنلاین — آیکن", "Send"),
          ...
          iconField("courses.buttonIcon", "دکمه دوره‌ها — آیکن", "GraduationCap"),
    ...
    sections: [
      {
        ...
        fields: [
          ...
          iconField("enterIcon", "دکمه ورود — آیکن", "ArrowLeft"),
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          iconField("chat.titleIcon", "عنوان — آیکن", "Headphones"),
          ...
          iconField("chat.startIcon", "شروع — آیکن", "Sparkles"),
          ...
          iconField("chat.sendIcon", "ارسال — آیکن", "Send"),
          iconField("chat.fabIcon", "دکمه شناور — آیکن", "MessageCircle"),
        ],
      },
      {
        id: "notifications",
