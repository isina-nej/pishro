...
export default function LandingAboutCmsPage() {
  ...
  return (
    <AdminPageShell
      title="درباره ما — رزومه، تیم و گواهی‌نامه‌ها"
      description="مدیریت اعضای تیم، سوابق و افتخارات مؤسسه پیشرو"
      actions={
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <span className="font-bold text-foreground">
              ویرایش زنده متون، تصاویر و آیکن‌های درباره ما:
            </span>
            <p className="mt-0.5 text-muted-foreground">
              برای ویرایش متن‌های صفحه، برچسب‌ها و آیکن‌های آمارها به استودیو CMS مراجعه کنید.
            </p>
          </div>
        </div>
