...
export class PersianDataGenerator {
  ...
  generateFullName(): { firstName: string; lastName: string } {
    const firstNames = [
      'محمد', 'علی', 'حسین', 'رضا', 'مهدی', 'احمد', 'حسن',
      'فاطمه', 'زهرا', 'مریم', 'سارا', 'نرگس', 'الهام', 'ندا',
      'امیر', 'پویا', 'سینا', 'آرش', 'کیان', 'پرهام', 'سامان',
      'آیدا', 'نیلوفر', 'شیدا', 'پریسا', 'نازنین', 'سمیرا'
    ];

    const lastNames = [
      'احمدی', 'محمدی', 'حسینی', 'رضایی', 'موسوی', 'کریمی', 'جعفری',
      'علیزاده', 'محمدزاده', 'حسن‌زاده', 'اکبری', 'نوری', 'صادقی',
      'فاضلی', 'رحیمی', 'کاظمی', 'باقری', 'اسماعیلی', 'حیدری',
      'نصیری', 'شریفی', 'زارعی', 'سلطانی', 'قاسمی', 'توکلی'
    ];
