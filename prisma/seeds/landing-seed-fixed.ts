...
/**
 * Safe create helper - replaces upsert for standalone MongoDB
 */
async function safeCreate<T>(model: any, whereClause: any, createData: any): Promise<T> {
...
export async function seedLandingPages() {
  ...
  // ==================== HOME LANDING ====================
  const homeLanding = await safeCreate(
    prisma.homeLanding,
    { id: "home-landing-1" },
    {
      id: "home-landing-1",
  ...
  const _step1 = await safeCreate(
    prisma.mobileScrollerStep,
    { id: "mobile-step-1" },
    {
      id: "mobile-step-1",
      stepNumber: 1,
  ...
  // ==================== ABOUT PAGE ====================
  const aboutPage = await safeCreate(
    prisma.aboutPage,
    { id: "about-page-1" },
    {
      id: "about-page-1",
  ...
  const businessConsulting = await safeCreate(
    prisma.businessConsulting,
  ...
  // ==================== INVESTMENT PLANS ====================
  const investmentPlans = await safeCreate(
    prisma.investmentPlans,
